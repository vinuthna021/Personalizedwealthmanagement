...
class Goal(Base):
    ...
    goal_type = Column(SQLEnum(GoalType, name="goaltype"), nullable=False)
    ...
    status = Column(SQLEnum(GoalStatus, name="goalstatus"), nullable=False, default=GoalStatus.ACTIVE)
